...
public class Prjava43romero18 extends Frame 
   ...
   public Prjava43romero18 () { 
      ...
      setTitle("nova finestra prjava43romero18");  // "this" Frame sets title 
    ...
    new Prjava43romero18();  // Let the construct do the job 
   } 
